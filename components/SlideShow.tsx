...
const SlideShow: React.FC<SlideShowProps> = ({ slides: initialSlides, onBack, topic, presentationId }) => {
  ...
  return (
    <div className="h-full flex flex-col bg-black text-white relative">
      {/* Navbar */}
      <div className="h-16 flex items-center justify-between px-6 border-b border-zinc-800 bg-zinc-900/50 relative z-20">
        
        {/* Left: Back + Undo/Redo */}
        <div className="flex items-center gap-4">
          <button onClick={onBack} className="p-2 hover:bg-zinc-800 rounded-full transition text-zinc-400 hover:text-white" title="Back to Home">
            <ArrowLeft size={20} />
          </button>
